...
namespace NewCore.Function.GPT
{
  ...
  public class IrMode : IIrModeBreakdown
  {
    ...
    public IrMode(GPT79904 gpt79904)
    {
      ...
      Measure = new MeasureManagment(_gptModel, delayBeforeCall, getTestTime: () => Task.FromResult(_config.TestTime), getRampTime: () => Task.FromResult(_config.RampTime), getIsIdleMode: GetIsIdleModeEnabled);
