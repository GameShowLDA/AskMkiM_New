...
namespace DTO.Device.Breakdown.Capabilities
{
  ...
  public interface IMeasurable
  {
    ...
    /// </returns>
    Task<(double value, string unit)> MeasureAsync(double param = 0, double rangeFrom = -1, double rangeTo = -1, bool waitFullTime = false, IUserMessageService? userMessageService = null);
