...
namespace UI.Windows.WpfDocking.Windows
{
    ...
    /// <remarks><para><see cref="AdornerManager"/> provides two attached properties: <see cref="P:UI.Windows.WpfDocking.Windows.AdornerManager.Adorner"/> to get or set <see cref="UIElement"/>
    /// as adorner of <see cref="FrameworkElement"/>; and <see cref="P:UI.Windows.WpfDocking.Windows.AdornerManager.AdornerTemplate" /> to get or set <see cref="DataTemplate"/>
    ...
    /// <para><see cref="P:UI.Windows.WpfDocking.Windows.AdornerManager.AdornerTemplate" /> provides similar functionality as <see cref="P:UI.Windows.WpfDocking.Windows.AdornerManager.Adorner"/>, however it can be used in style setters because
    ...
    /// <see cref="P:UI.Windows.WpfDocking.Windows.AdornerManager.Adorner"/> or <see cref="P:UI.Windows.WpfDocking.Windows.AdornerManager.AdornerTemplate" /> attached properties.</para></remarks>
    /// <example>The following example demostrates the usage of <see cref="P:UI.Windows.WpfDocking.Windows.AdornerManager.Adorner"/> and <see cref="P:UI.Windows.WpfDocking.Windows.AdornerManager.AdornerTemplate" /> attached property:
    ///     <code lang="xaml" source="..\..\Samples\Common\CSharp\AdornerManagerSample\Window1.xaml" />
    /// </example>
    public static partial class AdornerManager
    {
        /// <summary>Identifies the <see cref="P:UI.Windows.WpfDocking.Windows.AdornerManager.Adorner"/> attached property.</summary>
        ...
        /// <summary>Identifies the <see cref="P:UI.Windows.WpfDocking.Windows.AdornerManager.AdornerTemplate"/> attached property.</summary>
        /// <AttachedPropertyComments>
        ...
        /// <summary>Gets the value of <see cref="P:UI.Windows.WpfDocking.Windows.AdornerManager.Adorner"/> attached property
        /// from a given <see cref="FrameworkElement"/>.</summary>
        /// <param name="element">The element from which to read the property value.</param>
        /// <returns>The value of <see cref="P:UI.Windows.WpfDocking.Windows.AdornerManager.Adorner"/> attached property.</returns>
        public static UIElement GetAdorner(FrameworkElement element)
        {
            return (UIElement)element.GetValue(AdornerProperty);
        }

        /// <summary>Sets the value of <see cref="P:UI.Windows.WpfDocking.Windows.AdornerManager.Adorner"/> attached property
        /// to a given <see cref="FrameworkElement"/>.</summary>
        /// <param name="element">The element on which to set the property value.</param>
        /// <param name="value">The value of <see cref="P:UI.Windows.WpfDocking.Windows.AdornerManager.Adorner"/> attached property.</param>
        public static void SetAdorner(FrameworkElement element, UIElement value)
        {
            element.SetValue(AdornerProperty, value);
        }

        /// <summary>Gets the value of <see cref="P:UI.Windows.WpfDocking.Windows.AdornerManager.AdornerTemplate"/> attached property
        /// from a given <see cref="FrameworkElement"/>.</summary>
        /// <param name="element">The element from which to read the property value.</param>
        /// <returns>The value of <see cref="P:UI.Windows.WpfDocking.Windows.AdornerManager.AdornerTemplate"/> attached property.</returns>
        ...
        /// <summary>Sets the value of <see cref="P:UI.Windows.WpfDocking.Windows.AdornerManager.AdornerTemplate"/> attached property
        /// to a given <see cref="FrameworkElement"/>.</summary>
        /// <param name="element">The element on which to set the property value.</param>
        /// <param name="value">The value of <see cref="P:UI.Windows.WpfDocking.Windows.AdornerManager.AdornerTemplate"/> attached property.</param>
