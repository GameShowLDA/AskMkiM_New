...
namespace UI.Windows.WpfDocking.Windows
{
    ...
    /// <example>
    /// The following example shows how to avoid the <see cref="SecurityException"/> in XBAP application because <see cref="UI.Windows.WpfDocking.Windows.Docking.Primitives.NativeFloatingWindow"/> requires <see cref="UIPermission"/>:
    /// <code lang="xaml">
    /// <![CDATA[
    /// <ResourceDictionary>
