...
namespace UI.Windows.WpfDocking.Windows.Docking.Primitives
{
    ...
    /// <remarks>
    /// <para>By default, the <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.IsEnabled" /> attached property of <see cref="DockControl" /> is set to
    ...
    /// You can get the value from <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.FloatingWindowStrategy" /> attached property of <see cref="DockControl" />.</para>
    /// <para><see cref="DockManager"/> class handles drag and drop through the following attached properties:</para>
    /// <list type="bullet">
    /// <item>Set <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.CanDrag" /> attached property to <see langword="true"/> for element(s) in control template of
    ...
    /// <item>Set <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.TargetPosition"/> and <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.TargetItem"/>
    /// attached property for elements to indicate the drop target.</item>
    /// <item>The <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.ShowsGuide" /> attached property for <see cref="DockControl"/> and <see cref="DockPane"/> indicates
    /// whether docking guide should be displayed. The <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.ShowsLeftGuide" />,
    /// <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.ShowsRightGuide" />, <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.ShowsTopGuide" />,
    /// <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.ShowsBottomGuide" /> and <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.ShowsFillGuide" />
    /// attached properties for <see cref="DockControl"/> indicate whether the
    /// respective docking guide should be displayed. The <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.IsShiftKeyDown" /> attached property
    /// for <see cref="DockControl"/> indicates whether the SHIFT key is pressed down during drag and drop.</item>
    /// <item>The <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.Preview" /> attached property for <see cref="DockControl"/>, <see cref="DockPane"/> or <see cref="DockItem"/>
    /// indicates where the drop preview should be displayed. The <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.FloatingPreviewLeft" />,
    /// <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.FloatingPreviewTop" />, <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.FloatingPreviewWidth" />,
    /// <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.FloatingPreviewHeight" /> attached properties for <see cref="DockControl"/> indicates
    /// the floating preview size and location.</item>
    /// <item>In control template, set <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.Overlay" /> attached property for <see cref="FrameworkElement" /> to display the
    /// docking guide and preview overlay. Customize default floating window preview size by changing the value of
    /// <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.DefaultFloatingPreviewSize" /> attached property for <see cref="DockControl"/>.</item>
    /// </list>
    /// </remarks>
    public static partial class DockManager
    {
        /// <summary>Identifies the <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.IsEnabled"/> attached property.</summary>
        ...
        /// <remarks>The default style of <see cref="Docking.DockControl"/> class sets the <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.IsEnabled" />
        /// attached property to <see langword="true"/>. If you set the <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.IsEnabled" /> attached property
        ...
        /// <summary>Identifies the <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.FloatingWindowStrategy"/> attached property.</summary>
        /// <AttachedPropertyComments>
        ...
        /// <summary>Gets the value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.IsEnabled" /> attached property
        ...
        /// <returns>The value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.IsEnabled" /> attached property.</returns>
        public static bool GetIsEnabled(DockControl dockControl)
        {
            return (bool)dockControl.GetValue(IsEnabledProperty);
        }

        /// <summary>Sets the value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.IsEnabled" /> attached property
        ...
        /// <summary>Gets the value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.FloatingWindowStrategy" /> attached property
        /// from a given <see cref="DockControl" />.</summary>
        /// <param name="dockControl">The <see cref="DockControl"/> from which to read the property value.</param>
        /// <returns>The value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.FloatingWindowStrategy" /> attached property.</returns>
        ...
        /// <summary>Identifies the <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.Overlay"/> attached property.</summary>
        /// <AttachedPropertyComments>
        ...
        /// <remarks>In control template, set <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.Overlay" /> attached property for <see cref="FrameworkElement" /> to display the
        ...
        /// <summary>Identifies the <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.CanDrag" /> attached property.</summary>
        /// <AttachedPropertyComments>
        ...
        /// <remarks>Set <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.CanDrag" /> attached property to <see langword="true"/> for element(s) in control template of
        /// <see cref="WpfFloatingWindow"/>, <see cref="NativeFloatingWindow"/>, and <see cref="DockWindow"/> derived classes (<see cref="ToolWindow"/> and
        ...
        /// <summary>Identifies the <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.TargetPosition"/> attached property.</summary>
        /// <AttachedPropertyComments>
        ...
        /// <remarks>
        /// <para><see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.TargetItem"/> and <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.TargetPosition"/>
        ...
        ///         <term>not null</term>
        ///         <term><see cref="DropPosition.Left"/>, <see cref="DropPosition.Right"/>, <see cref="DropPosition.Top"/> or <see cref="DropPosition.Bottom"/></term>
        ///         <description>Show as side pane of specified <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.TargetItem" />'s <see cref="DockPane"/>.</description>
        ///     </item>
        ///     <item>
        ///         <term>not null</term>
        ///         <term><see cref="DropPosition.Fill"/></term>
        ///         <description>Show as last tab of specified <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.TargetItem"/>'s <see cref="DockPane"/>.</description>
        ///     </item>
        ///     <item>
        ///         <term>not null</term>
        ///         <term><see cref="DropPosition.Tab"/></term>
        ///         <description>Show as tab inserted before specified <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.TargetItem" />.</description>
        ///     </item>
        /// </list>
        /// </para>
        ...
        /// <summary>Identifies the <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.TargetItem"/> attached property.</summary>
        /// <AttachedPropertyComments>
        ...
        /// <summary>Identifies the <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.ShowsGuide"/> attached property.</summary>
        /// <AttachedPropertyComments>
        ...
        /// <summary>Identifies the <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.IsShiftKeyDown"/> attached property.</summary>
        /// <AttachedPropertyComments>
        ...
        /// <summary>Identifies the <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.ShowsLeftGuide"/> attached property.</summary>
        /// <AttachedPropertyComments>
        ...
        /// <summary>Identifies the <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.ShowsRightGuide"/> attached property.</summary>
        /// <AttachedPropertyComments>
        ...
        /// <summary>Identifies the <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.ShowsTopGuide"/> attached property.</summary>
        /// <AttachedPropertyComments>
        ...
        /// <summary>Identifies the <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.ShowsBottomGuide"/> attached property.</summary>
        /// <AttachedPropertyComments>
        ...
        /// <summary>Identifies the <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.ShowsFillGuide"/> attached property.</summary>
        /// <AttachedPropertyComments>
        ...
        /// <summary>Identifies the <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.Preview"/> attached property.</summary>
        /// <AttachedPropertyComments>
        ...
        /// <summary>Identifies the <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.FloatingPreviewLeft"/> attached property.</summary>
        /// <AttachedPropertyComments>
        ...
        /// <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.Preview"/> attached property is <see cref="DropPosition.Floating"/>.</value>
        /// </AttachedPropertyComments>
        public static readonly DependencyProperty FloatingPreviewLeftProperty = FloatingPreviewLeftPropertyKey.DependencyProperty;

        /// <summary>Identifies the <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.FloatingPreviewTop"/> attached property.</summary>
        /// <AttachedPropertyComments>
        ...
        /// <summary>Identifies the <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.FloatingPreviewWidth"/> attached property.</summary>
        /// <AttachedPropertyComments>
        ...
        /// <summary>Identifies the <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.FloatingPreviewHeight"/> attached property.</summary>
        /// <AttachedPropertyComments>
        ...
        /// <summary>Identifies the <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.DefaultFloatingPreviewSize"/> attached property.</summary>
        /// <AttachedPropertyComments>
        ...
        /// <summary>Gets the value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.Overlay" /> attached property
        ...
        /// <returns>The value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.Overlay" /> attached property.</returns>
        public static Overlay GetOverlay(FrameworkElement element)
        {
            return (Overlay)element.GetValue(OverlayProperty);
        }

        /// <summary>Sets the value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.Overlay" /> attached property
        ...
        /// <summary>Gets the value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.DefaultFloatingPreviewSize" /> attached property
        /// from a given <see cref="DockControl" />.</summary>
        /// <param name="dockControl">The <see cref="DockControl"/> from which to read the property value.</param>
        /// <returns>The value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.DefaultFloatingPreviewSize" /> attached property.</returns>
        ...
        /// <summary>Sets the value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.DefaultFloatingPreviewSize" /> attached property
        /// for a given <see cref="DockControl" />.</summary>
        /// <param name="dockControl">The <see cref="DockControl"/> on which to set the property value.</param>
        /// <param name="value">The property value to set.</param>
        ...
        /// <summary>Gets the value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.CanDrag" /> attached property
        /// from a given element.</summary>
        /// <param name="element">The element from which to read the property value.</param>
        /// <returns>The value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.CanDrag" /> attached property.</returns>
        public static bool GetCanDrag(DependencyObject element)
        {
            return (bool)element.GetValue(CanDragProperty);
        }

        /// <summary>Sets the value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.CanDrag" /> attached property
        ...
        /// <summary>Gets the value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.ShowsGuide" /> attached property
        /// from a given element.</summary>
        /// <param name="element">The element from which to read the property value.</param>
        /// <returns>The value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.ShowsGuide" /> attached property.</returns>
        ...
        /// <summary>Gets the value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.IsShiftKeyDown" /> attached property
        /// from a given <see cref="DockControl" />.</summary>
        /// <param name="dockControl">The <see cref="DockControl"/> from which to read the property value.</param>
        /// <returns>The value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.IsShiftKeyDown" /> attached property.</returns>
        ...
        /// <summary>Gets the value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.ShowsLeftGuide" /> attached property
        /// from a given <see cref="DockControl" />.</summary>
        /// <param name="dockControl">The <see cref="DockControl"/> from which to read the property value.</param>
        /// <returns>The value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.ShowsLeftGuide" /> attached property.</returns>
        public static bool GetShowsLeftGuide(DockControl dockControl)
        {
            return (bool)dockControl.GetValue(ShowsLeftGuideProperty);
        }

        /// <summary>Gets the value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.ShowsRightGuide" /> attached property
        /// from a given <see cref="DockControl" />.</summary>
        /// <param name="dockControl">The <see cref="DockControl"/> from which to read the property value.</param>
        /// <returns>The value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.ShowsRightGuide" /> attached property.</returns>
        public static bool GetShowsRightGuide(DockControl dockControl)
        {
            return (bool)dockControl.GetValue(ShowsRightGuideProperty);
        }

        /// <summary>Gets the value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.ShowsTopGuide" /> attached property
        /// from a given <see cref="DockControl" />.</summary>
        /// <param name="dockControl">The <see cref="DockControl"/> from which to read the property value.</param>
        /// <returns>The value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.ShowsTopGuide" /> attached property.</returns>
        public static bool GetShowsTopGuide(DockControl dockControl)
        {
            return (bool)dockControl.GetValue(ShowsTopGuideProperty);
        }

        /// <summary>Gets the value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.ShowsBottomGuide" /> attached property
        /// from a given <see cref="DockControl" />.</summary>
        /// <param name="dockControl">The <see cref="DockControl"/> from which to read the property value.</param>
        /// <returns>The value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.ShowsBottomGuide" /> attached property.</returns>
        public static bool GetShowsBottomGuide(DockControl dockControl)
        {
            return (bool)dockControl.GetValue(ShowsBottomGuideProperty);
        }

        /// <summary>Gets the value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.ShowsFillGuide" /> attached property
        /// from a given <see cref="DockControl" />.</summary>
        /// <param name="dockControl">The <see cref="DockControl"/> from which to read the property value.</param>
        /// <returns>The value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.ShowsFillGuide" /> attached property.</returns>
        ...
        /// <summary>Gets the value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.Preview" /> attached property
        /// from a given element.</summary>
        /// <param name="element">The element from which to read the property value.</param>
        /// <returns>The value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.Preview" /> attached property.</returns>
        ...
        /// <summary>Gets the value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.FloatingPreviewLeft" /> attached property
        /// from a given <see cref="DockControl" />.</summary>
        /// <param name="dockControl">The <see cref="DockControl"/> from which to read the property value.</param>
        /// <returns>The value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.FloatingPreviewLeft" /> attached property.</returns>
        ...
        /// <summary>Gets the value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.FloatingPreviewTop" /> attached property
        /// from a given <see cref="DockControl" />.</summary>
        /// <param name="dockControl">The <see cref="DockControl"/> from which to read the property value.</param>
        /// <returns>The value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.FloatingPreviewTop" /> attached property.</returns>
        ...
        /// <summary>Gets the value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.FloatingPreviewWidth" /> attached property
        /// from a given <see cref="DockControl" />.</summary>
        /// <param name="dockControl">The <see cref="DockControl"/> from which to read the property value.</param>
        /// <returns>The value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.FloatingPreviewWidth" /> attached property.</returns>
        ...
        /// <summary>Gets the value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.FloatingPreviewHeight" /> attached property
        /// from a given <see cref="DockControl" />.</summary>
        /// <param name="dockControl">The <see cref="DockControl"/> from which to read the property value.</param>
        /// <returns>The value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.FloatingPreviewHeight" /> attached property.</returns>
        ...
        /// <summary>Gets the value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.TargetItem" /> attached property
        /// from a given element.</summary>
        /// <param name="element">The element from which to read the property value.</param>
        /// <returns>The value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.TargetItem" /> attached property.</returns>
        public static DockItem GetTargetItem(DependencyObject element)
        {
            return (DockItem)element.GetValue(TargetItemProperty);
        }

        /// <summary>Sets the value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.TargetItem" /> attached property
        /// for a given element.</summary>
        /// <param name="element">The element on which to set the property value.</param>
        /// <param name="value">The property value to set.</param>
        ...
        /// <summary>Gets the value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.TargetPosition" /> attached property
        /// from a given element.</summary>
        /// <param name="element">The element from which to read the property value.</param>
        /// <returns>The value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.TargetPosition" /> attached property.</returns>
        ...
        /// <summary>Sets the value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.TargetPosition" /> attached property
        /// for a given element.</summary>
        /// <param name="element">The element on which to set the property value.</param>
        /// <param name="value">The property value to set.</param>
