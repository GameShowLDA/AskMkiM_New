...
namespace UI.Windows.WpfDocking.Windows.Docking.Primitives
{
    ...
    /// The <see cref="ContentControl.Content"/> property is bind to the <see cref="UI.Windows.WpfDocking.Windows.Docking.DockControl.SelectedAutoHideItem"/> property of
