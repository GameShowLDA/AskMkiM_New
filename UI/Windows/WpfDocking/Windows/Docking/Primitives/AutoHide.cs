...
namespace UI.Windows.WpfDocking.Windows.Docking.Primitives
{
    ...
    {
        /// <summary>Identifies the <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.AutoHide.Animation"/> attached property.</summary>
        ...
        /// <summary>Identifies the <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.AutoHide.AnimationDuration"/> attached property.</summary>
        /// <AttachedPropertyComments>
        ...
        /// <summary>Gets the value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.AutoHide.Animation" /> attached property
        ...
        /// <returns>The value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.AutoHide.Animation" /> attached property.</returns>
        ...
        /// <summary>Sets the value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.AutoHide.Animation" /> attached property
        ...
        /// <summary>Gets the value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.AutoHide.AnimationDuration" /> attached property
        /// from a given <see cref="DockControl" />.</summary>
        /// <param name="dockControl">The <see cref="DockControl"/> from which to read the property value.</param>
        /// <returns>The value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.AutoHide.AnimationDuration" /> attached property.</returns>
        ...
        /// <summary>Sets the value of <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.AutoHide.AnimationDuration" /> attached property
        /// for a given <see cref="DockControl" />.</summary>
        /// <param name="dockControl">The <see cref="DockControl"/> on which to set the property value.</param>
        /// <param name="value">The property value to set.</param>
