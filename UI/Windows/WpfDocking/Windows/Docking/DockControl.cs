...
namespace UI.Windows.WpfDocking.Windows.Docking
{
  ...
  ///     <item>
  ///         <term>AutoHide</term>
  ///         <description><see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.AutoHide.Animation" />, <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.AutoHide.AnimationDuration" />.</description>
  ///     </item>
  ///     <item>
  ///         <term>DockManager</term>
  ///         <description><see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.DefaultFloatingPreviewSize" />, <see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DockManager.FloatingWindowStrategy" />.</description>
  ///     </item>
  ///     <item>
  ///         <term>DocumentTab</term>
  ///         <description><see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.DocumentTab.ShowsIcon" />.</description>
  ///     </item>
  ///     <item>
  ///         <term>WindowSwitcher</term>
  ///         <description><see cref="P:UI.Windows.WpfDocking.Windows.Docking.Primitives.WindowSwitcher.Hotkey" /></description>
  ///     </item>
  /// </list>
  /// </para>
  /// </remarks>
