...
namespace UI.Windows.WpfDocking.Windows
{
    ...
    /// <remarks><para>This class provides <see cref="P:UI.Windows.WpfDocking.Windows.StyleManager.IsAutoMerge" /> attached property to automatically merge the default style change. The following XAML
    ...
    {
        /// <summary>Identifies the <see cref="P:UI.Windows.WpfDocking.Windows.StyleManager.IsAutoMerge" /> attached property.</summary>
        ...
        /// <remarks><para>You can use <see cref="P:UI.Windows.WpfDocking.Windows.StyleManager.IsAutoMerge" /> attached property to automatically merge the default style change. The following XAML
        /// defines a style based on the dynamic default style:</para>
        /// <code lang="xaml">
        /// <![CDATA[
        /// <Style TargetType={x:Type MenuItem}>
        ...
        /// <summary>Gets the value of <see cref="P:UI.Windows.WpfDocking.Windows.StyleManager.IsAutoMerge" /> attached property
        ...
        /// <returns>The value of <see cref="P:UI.Windows.WpfDocking.Windows.StyleManager.IsAutoMerge" /> attached property.</returns>
        public static bool GetIsAutoMerge(DependencyObject d)
        {
            return (bool)d.GetValue(IsAutoMergeProperty);
        }

        /// <summary>Sets the value of <see cref="P:UI.Windows.WpfDocking.Windows.StyleManager.IsAutoMerge" /> attached property
        ...
        /// <param name="value">The value of <see cref="P:UI.Windows.WpfDocking.Windows.StyleManager.IsAutoMerge" /> attached property.</param>
